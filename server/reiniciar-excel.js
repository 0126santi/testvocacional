...
function reiniciarExcel() {
  ...
  const hoja = xlsx.utils.aoa_to_sheet([["Nombre", "Apellido", "Edad", "Cédula", "Curso", "Unidad Educativa", "Resultado Principal", "Porcentaje Principal", "Resultado Secundario", "Porcentaje Secundario"]]);
